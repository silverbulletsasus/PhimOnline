		...
		<div class="row">
			...
			@endif
				<div class="panel panel-default">
					<div class="panel-heading">Thêm mới Thế Loại</div>
					<div class="panel-body">
						<form action="{{route('postAddTheLoai')}}" method="POST">
						<input type="hidden" name="_token" value="{{csrf_token()}}">
							...
							<div>
								...
								<textarea class="form-control" id="editor" name="txtContent"></textarea>
							</div>
							<br>
